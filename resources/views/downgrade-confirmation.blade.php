<x-guest-layout>
    <x-slot name="header">
        ...
        @section('description', __('Are you sure you want to downgrade your plan? You may lose access to some features.'))
    </x-slot>
    <div class="flex flex-col items-center justify-center px-4 my-10">
        <div class="w-full max-w-sm p-4 bg-white rounded shadow">
            ...
            <p class="mt-2 text-gray-500">Are you sure you want to downgrade your plan? You may lose access to some features.</p>
