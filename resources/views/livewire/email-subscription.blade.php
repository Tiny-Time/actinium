<div>
    <form wire:submit="subscribe" class="flex p-1 mt-3 bg-white dark:bg-[#8D8D8D] rounded">
        ...
        <button type="submit" class="inline-flex items-center px-4 py-2 uppercase transition duration-150 ease-in-out bg-red-400 rounded text-gray-50" wire:loading.attr="disabled">
            <svg class="w-5 h-5 mr-2 -ml-1 text-white animate-spin" wire:loading xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
