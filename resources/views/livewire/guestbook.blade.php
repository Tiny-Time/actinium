<form wire:submit="save" method="post" class="mt-4">
    ...
    <div class="relative flex flex-col w-full mt-3">
        <!-- Guestbook: Form - Input - Label -->
        <label for="g-email"
            class="ml-4 text-xs bg-white rounded-t-xl shadow w-max px-2 text-[#32214d] py-[2px] font-semibold -mb-1">Email
            <span class="text-red-500">*</span></label>
        <!-- Guestbook: Form - Input - Email -->
        <input type="email" wire:model.live="email" name="email" id="g-email"
    ...
    <div class="relative w-full mt-3">
        <div class="flex flex-col" wire:ignore>
            ...
            <label for="message"
                class="ml-4 text-xs bg-white rounded-t-xl shadow w-max px-2 text-[#32214d] py-[2px] font-semibold -mb-1">Message
                <span class="text-red-500">*</span></label>
            <!-- Guestbook: Form - Textarea -->
            <textarea wire:model="message" name="message" id="message" placeholder="Enter your message here..." cols="30"
                rows="3" class="text-[#32214d] border-none rounded-xl shadow focus:outline-none focus:ring-0"></textarea>
