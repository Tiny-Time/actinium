    ...
    <x-slot name="header">
        ...
        <div class="w-full px-4 mx-auto mt-6 max-w-7xl sm:px-6 lg:px-8">
            <section id="form" class="relative rounded-md bg-gradient-to-r from-teal-800/10 to-red-400/10 overflow-clip">
                <img loading="lazy" class="absolute -bottom-28 -right-14 -z-10 w-44" src="{{ Vite::asset('resources/images/time.webp') }}"
                    alt="Time">
                <img loading="lazy" class="absolute -top-20 -left-20 -z-10 w-44" src="{{ Vite::asset('resources/images/Alarm.webp') }}"
                    alt="Alarm">
