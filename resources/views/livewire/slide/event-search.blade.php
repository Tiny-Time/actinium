<div>
    <div class="flex items-center gap-3 mt-3">
        <div class="flex items-center flex-grow gap-2 p-2 bg-white rounded-lg">
            <svg width="19" height="18" wire:loading.class="hidden" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <svg class="w-5 h-5 text-blue-600 animate-spin" wire:loading xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                ...
                <div class="flex items-stretch">
                    ...
                    <div class="p-4">
                        <h3 class="mt-1 sm:text-lg leading-tight font-medium text-black line-clamp-1 md:line-clamp-2">
                            {{ $event->title }}</h3>
                        <p class="mt-1 text-slate-500 line-clamp-1 sm:line-clamp-3 text-sm">{{ $event->description }}</p>
                    </div>
                </div>
            </a>
        @endforeach
