        ...
        <div class="bg-[url('../images/timer-bg.png')] bg-no-repeat bg-cover relative z-10">
            <div class="timer-template" x-data="{ playBtn: true, counter: false }">
                <div class="flex items-center justify-between min-h-[300px] py-4 md:py-8 flex-col">
                    ...
                    {{-- Event Types --}}
                    <div class="flex flex-wrap justify-center gap-2 mt-3 text-xs md:gap-3 text-olivine">
                        {{-- Birthday --}}
    ...
    <div class="w-full overflow-x-auto">
        <div class="flex justify-between items-center bg-gray-100 px-4 py-2 sm:px-6 lg:px-8 min-w-[866px]">
            <div class="relative text-sm font-semibold leading-tight text-center">
                <span class="block">Custom integrations</span>
