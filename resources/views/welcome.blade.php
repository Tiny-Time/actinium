<x-guest-layout>
    <x-slot name="header">
        ...
        {{-- <div
            ...
            @elseif (!$isMobile && Route::has('login'))
                <button class="px-4 py-2 m-4 text-white bg-green-500 rounded" @click="openSignUpModal = !openSignUpModal">
                    OpenSignUpModal Modal Dialog
                </button>
            @endif
        </div> --}}
    </x-slot>
