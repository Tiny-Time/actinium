<x-guest-layout>
            ...
            <div class="timer-template" x-data="{ playBtn: true, counter: false }">
                <div class="flex items-center justify-between min-h-[300px] py-4 md:py-8 flex-col">
                    ...
                    <div class="flex flex-wrap justify-center gap-2 mt-3 text-xs md:gap-3 text-olivine">
                        {{-- Birthday --}}
                        <a href="{{ route('search', ['cat' => 'birthday']) }}">
                        ...
                        {{-- Wedding --}}
                        <a href="{{ route('search', ['cat' => 'wedding']) }}">
                            <div class="flex flex-col items-center gap-1">
                        ...
                        {{-- Pregnancy --}}
                        <a href="{{ route('search', ['cat' => 'pregnancy']) }}">
                            <div class="flex flex-col items-center gap-1">
                        ...
                        {{-- Graduation --}}
                        <a href="{{ route('search', parameters: ['cat' => 'graduation']) }}">
                            <div class="flex flex-col items-center gap-1">
                                <div class="rounded-full p-4 w-max bg-[#BADF9A]">
                                    <svg class="inline w-7 h-7" viewBox="0 0 49 49" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_1_4018)">
                                            ...
                                            <path d="M36.1408 33.4033V24.7018L26.1718 19.7191" stroke="#164300"
                                                stroke-width="1.48867" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path
                        ...
                        {{-- Breaks --}}
                        <a href="{{ route('search', ['cat' => 'breaks']) }}">
                            <div class="flex flex-col items-center gap-1">
                                <div class="rounded-full p-4 w-max bg-[#BADF9A]">
                                    <svg class="inline w-7 h-7" viewBox="0 0 49 49" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        {{-- Holiday --}}
                        <a href="{{ route('search', ['cat' => 'holiday']) }}">
                            <div class="flex flex-col items-center gap-1">
                        ...
                        {{-- Meetings --}}
                        <a href="{{ route('search', ['cat' => 'meetings']) }}">
                            <div class="flex flex-col items-center gap-1">
                                <div class="p-4 rounded-full w-max bg-olivine">
                                    <svg class="inline w-7 h-7" viewBox="0 0 49 49" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        {{-- Product Launch --}}
                        <a href="{{ route('search', ['cat' => 'product-launch']) }}">
                            <div class="flex flex-col items-center gap-1">
                                <div class="rounded-full p-4 w-max bg-[#364500]">
                                    <svg class="inline w-7 h-7" viewBox="0 0 49 49" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        {{-- Live Streaming --}}
                        <a href="{{ route('search', ['cat' => 'live-streaming']) }}">
                            <div class="flex flex-col items-center gap-1">
                                <div class="p-4 rounded-full w-max bg-olivine">
                                    <svg class="inline w-7 h-7" viewBox="0 0 49 49" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
            ...
            <div
                ...
                <div class="flex w-full flex-nowrap">
                    <ul
                        ...
                        <li>
                            {{-- Streamlabs --}}
                            <img loading="lazy" src="{{ Vite::asset('resources/images/streamlabs.webp') }}"
                                width="150" height="30" alt="Streamlabs Timer Widget">
                        </li>
                        <li>
                            {{-- Shopify --}}
    ...
    <div class="px-4 mx-auto mt-8 max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="grid gap-6 mt-6 md:grid-cols-2 md:gap-16">
            <img loading="lazy" src="{{ Vite::asset('resources/images/feature image 1.webp') }}"
                alt="Multiple Templates" class="w-[550px] mx-auto">
        ...
        <div class="flex flex-col-reverse gap-6 mt-6 md:grid md:grid-cols-2 md:gap-16">
            ...
            <img loading="lazy" src="{{ Vite::asset('resources/images/feature image 2.webp') }}"
                alt="Website Integration" class="w-[550px] mx-auto">
        </div>
                                ...
                                @if ($testimonials->isEmpty())
                                    <li class="splide__slide">
                                        ...
                                        <div class="relative min-w-[260px]">
                                            ...
                                            <div class="flex items-center gap-3 px-3 py-6 text-gray-100 bg-gm">
                                                <img loading="lazy"
                                                    src="{{ Vite::asset('resources/images/profile image.webp') }}"
                                    ...
                                    <li class="splide__slide">
                                        ...
                                        <div class="relative min-w-[260px]">
                                            ...
                                            <div class="flex items-center gap-3 px-3 py-6 text-gray-100 bg-gm">
                                                <img loading="lazy"
                                                    src="{{ Vite::asset('resources/images/profile image 2.webp') }}"
                                                    alt="Profile" class="flex-shrink rounded-full max-w-[70px]">
                                                <div>
                                    ...
                                    <li class="splide__slide">
                                        ...
                                        <div class="relative min-w-[260px]">
                                            ...
                                            <div class="flex items-center gap-3 px-3 py-6 text-gray-100 bg-gm">
                                                <img loading="lazy"
                                                    src="{{ Vite::asset('resources/images/profile image 3.webp') }}"
                                                    alt="Profile" class="flex-shrink rounded-full max-w-[70px]">
                                                <div>
                                    ...
                                    @foreach ($testimonials as $testimonial)
                                        <li class="splide__slide">
                                            ...
                                            <div class="relative min-w-[260px]">
                                                ...
                                                <div class="flex items-center gap-3 px-3 py-6 text-gray-100 bg-gm">
                                                    <img loading="lazy"
                                                        src="{{ $testimonial->image ? '/storage/' . $testimonial->image : 'https://ui-avatars.com/api/?name=' . $testimonial->name . '&background=A2C376&color=fff&bold=true' }}"
