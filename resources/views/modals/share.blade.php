                ...
                <div class="w-full p-4 -mb-4">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="flex flex-wrap justify-center gap-4">
                            ...
                            <!-- Telegram -->
                            <a href="https://t.me/share/url?url={{ urlencode(request()->url()) }}&text={{ urlencode($event->title) }}"
                            ...
                            <!-- Email -->
                            <a href="mailto:?subject={{ urlencode($event->title) }}&body={{ urlencode($event->description . ' ' . $event->title . ' ' . request()->url()) }}"
