    ...
    <div class="w-full px-4 mt-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-6 mt-8">
            ...
            <article class="md:col-span-2">
                ...
                {{-- Post Title --}}
                <h1 class="text-xl sm:text-3xl font-bold mt-3 px-4 text-center">{{ $post->title ?? '' }}</h1>
                ...
                <div class="uppercase font-semibold items-center mt-3 flex justify-center flex-wrap gap-2 text-sm">
                    ...
                    <a href="https://www.facebook.com/sharer.php?u={{ route('post', $post->slug) }}"
                        class="hover:bg-olivine rounded shadow flex items-center px-2 py-1 gap-1 bg-blue-600 text-gray-50">
                    ...
                    <a href="https://twitter.com/intent/tweet?text={{ $post->title ?? '' }}&url={{ route('post', $post->slug) }}"
                        class="hover:bg-olivine rounded shadow flex items-center px-2 py-1 gap-1 bg-black text-gray-50">
                    ...
                    <a href="https://pinterest.com/pin/create/button/?url={{ route('post', $post->slug) }}&media={{ !empty($post->image()) ? $post->image() : Vite::asset('resources/images/bg.jpg') }}&description={{ $post->title ?? '' }}"
                        class="hover:bg-olivine rounded shadow flex items-center px-2 py-1 gap-1 bg-red-600 text-gray-50">
            ...
            @include($skyTheme . '.partial.sidebar', [
                ...
                'recent' => \LaraZeus\Sky\Models\Post::latest()->take(5)->get(),
            ])
        </div>
    </div>
