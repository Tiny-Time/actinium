        ...
        <div class="flex items-center justify-between">
            ...
            @if (!request()->routeIs('search'))
                <form method="GET" action="{{ route('search') }}"
                    ...
                    <input type="search" placeholder="Search for an event near you..." name="q" id="find-event"
                    ...
                    <button type="submit" class="block h-full px-3 text-lg font-semibold text-gray-100 bg-red-400">Find
                        Event</button>
                </form>
            @endif
            @auth
    ...
    <div class="px-4 py-2 mx-auto max-w-7xl sm:px-6 lg:px-8 md:hidden" x-data="{ menuOverlay: false, searchOverlay: false }">
        ...
        <div class="absolute top-0 bottom-0 left-0 right-0 z-20 px-4 bg-gray-100" x-cloak
            ...
            <div class="mt-3 other-links">
                <a href="{{ route('search') }}" class="block mt-3 text-gray-600 hover:text-gray-900">Events</a>
