<x-filament-panels::page x-data="{ activeTab: 'analytics' }">
    ...
    <div class="pb-4 bg-white rounded-md shadow" id="form" x-show="activeTab == 'form'">
        {{-- Wizard Steps --}}
    ...
    <div id="rsvp" x-show="activeTab == 'rsvp'">
        @if (count($rsvpManager = array($this->getRelationManagers()[0])))
    ...
    <div id="guestbook" x-show="activeTab == 'guestbook'">
        @if (count($guestbookManager = array($this->getRelationManagers()[1])))
