<div>
    ...
    <div class="flex gap-1">
        <div class="flex items-center w-full bg-gray-100 rounded-lg shadow dark:text-gray-700" x-data="{ shareUrl: @entangle('preview_url') }">
            ...
            <button type="button" x-on:click="$clipboard(shareUrl, true)" class="px-3">
