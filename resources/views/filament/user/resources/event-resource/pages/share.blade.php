<div x-data="{ shareUrl: 'URL to be copied to clipboard!' }">
    ...
    <div class="flex flex-wrap justify-center gap-4">
        ...
        {{-- Telegram --}}
        <a href="https://t.me/share/url?text=Check out my new event on Tinyti.me&url={{ $preview_url }}}"
        ...
        {{-- XTwitter --}}
        <a href="https://twitter.com/intent/tweet?text=Check out my new event on Tinyti.me&url={{ $preview_url }}"
    ...
    <div class="flex gap-1">
        <div class="flex items-center w-full bg-gray-100 rounded-lg shadow dark:text-gray-700" x-data="{ shareUrl: '{{ $preview_url }}' }">
            <label for="shareUrl" class="sr-only">Share URL</label>
            <input type="url" name="shareUrl" id="shareUrl" x-model="shareUrl" value="{{ $preview_url }}"
        ...
        <button type="button" @click="isHidden = !isHidden; $dispatch('open-modal', { id: 'edit-url' });"
            aria-label="Edit URL" class="px-2 bg-gray-100 rounded-lg shadow text-[#EE6C4D]">
