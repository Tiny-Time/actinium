            ...
            <div class="px-4 py-4 content">
                <div class="flex">
                    <div class="p-2 bg-yellow-500 rounded-md h-max w-max">
                        <svg class="w-12 h-12" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M44.25 25C44.25 27.4623 43.765 29.9005 42.8227 32.1753C41.8805 34.4502 40.4993 36.5172 38.7582 38.2582C37.0172 39.9993 34.9502 41.3805 32.6753 42.3227C30.4005 43.265 27.9623 43.75 25.5 43.75C23.0377 43.75 20.5995 43.265 18.3247 42.3227C16.0498 41.3805 13.9828 39.9993 12.2417 38.2582C10.5006 36.5172 9.11953 34.4502 8.17726 32.1753C7.23498 29.9005 6.75 27.4623 6.75 25C6.75 20.0272 8.72544 15.2581 12.2417 11.7417C15.7581 8.22544 20.5272 6.25 25.5 6.25C30.4728 6.25 35.2419 8.22544 38.7582 11.7417C42.2746 15.2581 44.25 20.0272 44.25 25Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M19.25 19.9229C19.25 19.275 19.775 18.75 20.4229 18.75H30.5771C31.225 18.75 31.75 19.275 31.75 19.9229V30.0771C31.75 30.725 31.225 31.25 30.5771 31.25H20.425C20.2707 31.2505 20.1179 31.2206 19.9752 31.1619C19.8325 31.1032 19.7029 31.0168 19.5937 30.9078C19.4845 30.7988 19.3979 30.6693 19.3389 30.5267C19.2799 30.3842 19.2497 30.2314 19.25 30.0771V19.925V19.9229Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                    <div class="ml-3">
            ...
            <div class="px-4 py-4 content">
                <div class="flex">
                    <div class="p-2 bg-pink-600 rounded-md h-max w-max">
                        <svg class="w-12 h-12" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M42.9375 15.625L41.6354 37.775C41.5653 38.9689 41.0414 40.0907 40.1712 40.911C39.3009 41.7313 38.1501 42.188 36.9542 42.1875H14.5458C13.3499 42.188 12.1991 41.7313 11.3288 40.911C10.4586 40.0907 9.93474 38.9689 9.86458 37.775L8.5625 15.625M21.0625 24.2187L25.75 28.9062M25.75 28.9062L30.4375 33.5937M25.75 28.9062L30.4375 24.2187M25.75 28.9062L21.0625 33.5937M7.78125 15.625H43.7187C45.0125 15.625 46.0625 14.575 46.0625 13.2812V10.1562C46.0625 8.8625 45.0125 7.8125 43.7187 7.8125H7.78125C6.4875 7.8125 5.4375 8.8625 5.4375 10.1562V13.2812C5.4375 14.575 6.4875 15.625 7.78125 15.625Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                    <div class="ml-3">
