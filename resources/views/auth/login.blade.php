<x-guest-layout>
    ...
    @section('description', __('TinyTime: A user-friendly platform for effortless event planning and personalization.
        Create events, birthdays, product launch, live streaming and more with ease. Sign in now!'))
