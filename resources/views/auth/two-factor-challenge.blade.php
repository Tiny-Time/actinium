<x-guest-layout>
    @section('title', __('Two-Factor Challenge - TinyTime'))

    @section('description', __('Secure your TinyTime account with two-factor authentication. Verify your identity to
        continue enjoying effortless event planning.'))
