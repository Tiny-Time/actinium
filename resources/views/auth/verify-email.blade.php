<x-guest-layout>
    @section('title', __('Verify Email - TinyTime'))

    @section('description', __('Verify your email to secure your TinyTime account and start planning personalized events
        with ease!'))
        ...
        <x-authentication-card title="Verify Your Email">
            ...
            <p class="my-4 text-sm text-center text-gray-600 dark:text-gray-400">
