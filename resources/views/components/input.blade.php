...
<input {{ $disabled ? 'disabled' : '' }} id="{{ $id }}" type="{{ $type }}" {!! $attributes->merge([
    'class' => 'w-full bg-transparent border-none focus:outline-none focus:ring-0 text-sm rounded-lg',
]) !!} />
...
@if ($id === 'password')
    <div x-data="showPasswordDiv">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="w-5 h-5 absolute top-[10px] right-2 cursor-pointer" @click="toggle" x-show="showPassword">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="w-5 h-5 absolute top-[10px] right-2 cursor-pointer" @click="toggle"
            x-show="!showPassword">
            <path stroke-linecap="round" stroke-linejoin="round"
