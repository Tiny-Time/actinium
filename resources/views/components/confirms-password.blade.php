...
@once
    <x-dialog-modal wire:model.live="confirmingPassword">
        ...
        <x-slot name="content">
            ...
            <p class="mt-1 font-bold">Don't know or remember your password? <span class="font-normal">Click <a
                        href="{{ route('password.request') }}" class="font-bold text-indigo-500">Forgot Password</a> to
                    reset or set a new password.</span></p>
        </x-slot>
