    ...
    <div class="toz-timer">
        ...
        <div class="toz-ec-d">
            <svg width="300" height="301" viewBox="0 0 300 301" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <rect x="10" y="10.5" width="280" height="280" rx="140" stroke-opacity="0.3" id="toz-day" />
            </svg>
        ...
        <div class="toz-ec-d">
            <svg width="300" height="301" viewBox="0 0 300 301" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="10" y="10.5" width="280" height="280" rx="140" stroke="white" stroke-width="22"
                    stroke-dasharray="4 12" />
                <rect x="10" y="10.5" width="280" height="280" rx="140" stroke-opacity="0.3" id="toz-hr" />
            </svg>
            <div class="toz-hours">
        ...
        <div class="toz-ec-d">
            <svg width="300" height="301" viewBox="0 0 300 301" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="10" y="10.5" width="280" height="280" rx="140" stroke="white" stroke-width="22"
                    stroke-dasharray="4 12" />
                <rect x="10" y="10.5" width="280" height="280" rx="140" stroke-opacity="0.3" id="toz-mn" />
            </svg>
            <div class="toz-mins">
        ...
        <div class="toz-ec-d">
            <svg width="300" height="301" viewBox="0 0 300 301" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="10" y="10.5" width="280" height="280" rx="140" stroke="white" stroke-width="22"
                    stroke-dasharray="4 12" />
                <rect x="10" y="10.5" width="280" height="280" rx="140" stroke-opacity="0.3" id="toz-es" />
            </svg>
