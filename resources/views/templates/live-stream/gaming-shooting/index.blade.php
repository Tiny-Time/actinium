<x-template :event="$event" :userIP="$userIP">
    ...
    <x-slot:live>
        <div class="mb-3">
            <img loading="lazy" src="{{ Vite::asset('resources/views/templates/live-stream/gaming-shooting/images/icon.webp') }}"
    ...
    <div class="toz-timer">
        <!-- Days -->
        <div class="toz-ec-d">
            <img loading="lazy" src="{{ Vite::asset('resources/views/templates/live-stream/gaming-shooting/images/timer_icon.webp') }}"
                alt="Timer icon">
            <div>
