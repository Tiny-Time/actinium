<x-template :event="$event" :userIP="$userIP">
    ...
    <x-slot:live>
        <div class="mb-3">
            <img src="{{ Vite::asset('resources/views/templates/live-stream/gaming-arcade/images/live_icon.webp') }}"
    ...
    <div class="toz-timer">
        <!-- Days -->
        <div class="toz-ec-d">
            <img src="{{ Vite::asset('resources/views/templates/live-stream/gaming-arcade/images/timer_icon.webp') }}"
                alt="Timer icon">
            <div>
