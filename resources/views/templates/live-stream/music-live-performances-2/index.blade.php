<x-template :event="$event" :userIP="$userIP">
    ...
    <x-slot:live>
        <div class="toz-icon mb-3">
            <img src="{{ Vite::asset('resources/views/templates/live-stream/music-live-performances-2/images/icon.webp') }}"
    ...
    <div class="toz-timer">
        <!-- Days -->
        <div class="toz-ec-d">
            <img src="{{ Vite::asset('resources/views/templates/live-stream/music-live-performances-2/images/timer_icon.webp') }}"
                alt="Timer icon">
            <div>
