<x-template :event="$event" :userIP="$userIP">
    <x-slot:css>
        <link rel="stylesheet"
            href="{{ Vite::asset('resources/views/templates/plant/watering-effortless/css/style.css') }}" />
    </x-slot>
    ...
    <div class="toz-timer">
        ...
        <div class="toz-ec">
            <div class="toz-ec-d">
                <img src="{{ Vite::asset('resources/views/templates/plant/watering-effortless/images/timer_icon.webp') }}" alt="Timer icon" />
