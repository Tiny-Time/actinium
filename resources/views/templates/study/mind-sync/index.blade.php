<x-template :event="$event" :userIP="$userIP">
    <x-slot:css>
        <link rel="stylesheet" href="{{ Vite::asset('resources/views/templates/study/mind-sync/css/style.css') }}" />
    </x-slot>
    ...
    <div class="toz-timer">
        <!-- Days -->
        <div class="toz-ec-d">
            <svg width="190" height="170" id="first">
        ...
        <!-- Hours -->
        <div class="toz-ec-d">
            <svg width="190" height="170" id="second">
                <circle cx="95" cy="85" r="75" />
        ...
        <!-- Minutes -->
        <div class="toz-ec-d">
            <svg width="190" height="170" id="third">
                <circle cx="95" cy="85" r="75" />
        ...
        <!-- Seconds -->
        <div class="toz-ec-d">
            <svg width="190" height="170" id="fourth">
                <circle cx="95" cy="85" r="75" />
