<x-template :event="$event" :userIP="$userIP">
    <x-slot:css>
        <link rel="stylesheet"
            href="{{ Vite::asset('resources/views/templates/birthday/ticking-time/css/style.css') }}" />
    </x-slot>
    ...
    <div class="toz-timer">
        ...
        <div class="toz-ec">
            <div class="toz-ec-d">
                <img src="{{ Vite::asset('resources/views/templates/birthday/ticking-time/images/timer_icon.svg') }}" alt="Timer icon" />
